...
PUNCTUAL_SHOW_VIRTUAL_ENV="${PUNCTUAL_SHOW_VIRTUAL_ENV:-true}";
...
PUNCTUAL_VIRTUAL_ENV_COLOUR="${PUNCTUAL_VIRTUAL_ENV_COLOUR=:-green}";
...
PUNCTUAL_VIRTUAL_ENV_BOLD="${PUNCTUAL_VIRTUAL_ENV_BOLD=:-false}";

PUNCTUAL_TIMESTAMP_FORMAT="${PUNCTUAL_TIMESTAMP_FORMAT:-%H:%M}"; # see man strftime
...
punctualBuildTheme () {
    ...
    if [[ ${PUNCTUAL_SHOW_VIRTUAL_ENV} = true ]]; then
        punctualPyVenv;
        echo -n ' ';
    fi;
    punctualNewline;
